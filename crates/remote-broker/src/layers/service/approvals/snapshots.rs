...
pub(crate) fn build_queue_snapshots(pending: &[PendingRequest]) -> Vec<RequestSnapshot> {
...
pub(crate) fn running_snapshot_from_pending(
...
pub(crate) fn result_snapshot_from_response(
    pending: &PendingRequest,
