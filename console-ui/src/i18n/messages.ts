  ...
  'zh-CN': {
    ...
    settings: {
      ...
      chat: {
        ...
        diagnostics: {
          run: '运行配置自检',
          help: '尝试检查本地启动配置、MCP JSON、OpenAI 兼容 API，以及 ACP / Codex 初始化情况。',
          running: '正在检查配置，请稍候…',
          failedTitle: '配置自检失败',
          resultTitle: '自检结果',
          summaryOk: '所有关键检查均已通过或仅有可忽略提示。',
          summaryFail: '存在需要处理的问题，请根据下面的建议修复。',
          suggestion: '建议',
          overall: {
            pass: '通过',
            fail: '有问题',
    ...
    settings: {
      ...
      chat: {
        ...
        diagnostics: {
          ...
          help: 'Tests local startup config, MCP JSON, OpenAI-compatible API access, and ACP / Codex initialization.',
          running: 'Checking configuration, please wait…',
          failedTitle: 'Config check failed',
          resultTitle: 'Check results',
          summaryOk: 'All critical checks passed or only produced non-blocking warnings.',
          summaryFail: 'Some issues need attention. Use the suggestions below to fix them.',
